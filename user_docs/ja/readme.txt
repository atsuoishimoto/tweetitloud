...
同梱されているjtalk for nvdajpは、まだ開発中の音声エンジンです。そのため、利用者の方からのフィードバックをお待ちしております。ご使用いただき、お気づきの点がございましたら、[http://nvdajp-jtalk-dic.heroku.com nvdajp-jtalk-dic]へのフィードバックでお知らせください。
